      ...
      <div className="report-container">
        ...
        <section className="report-section">
          ...
          <div className="report-content">
            <div className="report-text">
              ...
              <p>
                自由が丘店は、決して「屈指の繁忙店」ではありません。しかし私は12月の最繁忙期に、店舗の歴史の中で断トツとなる「1650万円」の月商を達成しました。従来のレコードを113%以上更新したこの数字は、全国440店舗以上の全ビックエコーの中で12位という偉業に繋がりました。
              </p>
              
              <h3>【戦略的アプローチ：現場判断力】</h3>
              <ul>
                <li><strong>210時間の現場執念：</strong> 店長すら凌駕する210時間の稼働。全営業時間の約35%を現場で指揮し、アップセルやリピーター獲得のための接客を徹底しました。</li>
                <li><strong>開発への還元：</strong> 現場で磨いた「不測の事態でもユーザーを迷わせない優先順位判断」を、CLIP STUDIO PAINTの安定稼働とUI/UXの最適化に応用します。</li>
              </ul>
            ...
            <div className="report-visual shift-visual" onClick={() => setSelectedImg('/shift.jpg')}>
              ...
              <p className="caption">図1：12月のシフト。この過密な記録が、ユーザーを支えるスタミナの証。</p>
            </div>
          </div>
        </section>
        ...
        <section className="report-section">
          <div className="section-manga-eye">
            ...
            <h2>学費450万の完納。920万の覚悟は「生涯の責任」である誓い。</h2>
          </div>
          ...
          <div className="report-content reverse">
            <div className="report-text">
              ...
              <p>
                母は他界し、父親の生活保護受給という環境下、3年に渡る独学で大学進学を掴み取りました。4年間、深夜勤務と研究を一切の手抜きなく並行。2025年度には源泉徴収額210万円を記録しました。
              </p>
              ...
              <div className="result-box-highlight">
                <p><strong>■ 学費領収書：4.5M円 自力完納（不動のガッツ）</strong></p>
                <p><strong>■ 源泉徴収：2.1M円（学生の枠を破壊する実行力）</strong></p>
              </div>
            </div>
            ...
            <div className="visual-column-emphasized">
              ...
              <div className="report-visual gensen-impact" onClick={() => setSelectedImg('/gensen.png')}>
                ...
                <div className="impact-badge">実録：2.1M</div>
              ...
              <div className="report-visual tuition-small" onClick={() => setSelectedImg('/tuition.jpg')}>
                ...
                <p className="caption">図3：4.5M完納の証明。</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <footer className="report-footer">
          ...
          <div className="value-grid">
            <div className="value-card">
              ...
              <p>
                繁忙期の210時間稼働と研究を両立させた体力。
                あなたが描き終えるその瞬間まで、あなたが”好き”を追い続けられるように、私はあなたを思い、システムを支え続けます。
              </p>
            </div>
            <div className="value-card">
